...
if st.button("전송"):
    if pdf_file is None:
        ...
        system_prompt = (
            "당신은 보험 상품 약관에서 핵심 정보를 추출하는 AI 에이전트입니다. "
            "주어진 보험 상품 약관 PDF에서 아래 정보를 담보별로 구분하여 테이블 형태로 제공하세요:\n"
            "정보가 불충분하더라도 추출 가능한 내용을 최대한 체계적으로 정리하여 제공하세요. 정보가 부족하다는 말은 하지마세요.\n"
            "1. 상품 기본 정보 (무배당/배당 여부: 상품명에 '무배당' 포함시 무배당, '배당형' 포함시 배당 여부, 갱신형/비갱신형 여부: 상품명에 '갱신형' 포함시 갱신형, '비갱신형' 포함시 비갱신형)\n"
